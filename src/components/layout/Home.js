...
function Home() {
  return (
    <main className="desktop:max-w-9xl mx-auto mt-14 w-10/12 laptop:mt-32 laptop:flex laptop:justify-between laptop:gap-2 desktop:mt-40 desktop:mb-16 desktop:gap-[15%]">
      <div className="mx-auto max-w-md text-center text-fog laptop:w-[45%] laptop:max-w-[20rem] desktop:max-w-[25rem]">
        ...
        <p className="font-barlow-condensed text-[1rem] font-light leading-7 tablet:text-lg desktop:text-left desktop:text-xl desktop:leading-9 desktop:tracking-wide">
      ...
      <div className="mt-12 grid place-items-center py-8 tablet:my-10 laptop:w-[35%]">
        <button className="h-40 w-40 rounded-full bg-white font-bellefair text-2xl desktop:mt-12 desktop:h-52 desktop:w-52 desktop:mr-20">
          EXPLORE
        </button>
      </div>
    </main>
